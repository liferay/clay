        ...
        <div className="quick-action-menu">
          ...
          >
            <svg
              ...
              role="presentation"
            >
              <use href="/icons.svg#info-circle-open" />
            </svg>
          </a>
        </div>
      ...
      <div className="autofit-col autofit-col-expand">
        <section className="autofit-section">
          ...
          <p className="list-group-text">
            This is an example of .list-group-text and a <a href="#1">link</a>.
          </p>
          <p className="list-group-text">
          ...
          <p className="list-group-subtext">
            <span className="text-truncate-inline">
              <a className="list-group-subtext-link text-truncate" href="#1">
        ...
        <div className="quick-action-menu">
          ...
          >
            <svg
              ...
              role="presentation"
            >
              <use xlink:href="/icons.svg#expand"></use>
            </svg>
          </a>
        </div>
        <div className="dropdown dropdown-action">
  ...
  <li className="list-group-item list-group-item-flex">
    ...
    <div className="autofit-col">
      ...
      <div className="dropdown dropdown-action">
        ...
        <ul aria-labelledby="" className="dropdown-menu dropdown-menu-right">
          <li>
            <a className="dropdown-item" href="#1" role="button">Remove</a>
          </li>
          <li>
            <a className="dropdown-item" href="#1" role="button">Download</a>
          </li>
          <li>
            <a className="dropdown-item" href="#1" role="button">Checkout</a>
          </li>
        </ul>
      </div>
    </div>
