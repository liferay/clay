...
export default function App() {
  ...
  return (
    <Provider spritemap="/icons.svg">
      <div className="p-4">
        <>
          <Tabs active={active} displayType="light" onActiveChange={setActive}>
            <Tabs.List>
              <Tabs.Item
                innerProps={{
                  'aria-controls': 'tabpanel-1',
...
export default function App() {
  ...
  return (
    <Provider spritemap="/icons.svg">
      <div className="p-4">
        <>
          <Tabs active={active} modern onActiveChange={setActive}>
            <Tabs.Item
              innerProps={{
                'aria-controls': 'tabpanel-1',
              }}
                  ...
                  ({disabled = false, label, tabkey}, i) => {
                    return (
                      <DropDown.Item
                        ...
                        role="tab"
                        symbolRight={active === tabkey ? 'check' : undefined}
                      >
                        {label}
                      </DropDown.Item>
                    );
