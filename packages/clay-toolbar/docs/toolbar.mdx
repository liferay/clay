...
packageTypes:
    [
        'clay-toolbar/src',
        'clay-toolbar/src/action',
        'clay-toolbar/src/input',
        'clay-toolbar/src/item',
        'clay-toolbar/src/label',
        'clay-toolbar/src/link',
        'clay-toolbar/src/nav',
        'clay-toolbar/src/section',
    ]
---
