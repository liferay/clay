...
<div className="clay-site-alert alert alert-warning">
  Using the color classes will set the background-color on progress-bar, no need
  to use{' '}
  <a
    ...
    <div className="progress-group-addon">
      <div className="progress-group-feedback">
        <svg
          ...
          role="presentation"
        >
          <use href="/icons.svg#info-exclamation-circle" />
        </svg>
      </div>
    </div>
  </div>
    ...
    <div className="progress-group-addon">
      <div className="progress-group-feedback">
        <svg
          ...
          role="presentation"
        >
          <use href="/icons.svg#times-circle" />
        </svg>
      </div>
    </div>
  </div>
