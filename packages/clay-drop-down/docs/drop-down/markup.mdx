...
<div className="clay-site-alert alert alert-warning">
  ...
  plugin in 7.4, just replace the attribute <code>data-toggle="dropdown"</code>{' '}
  with <code>data-toggle="liferay-dropdown"</code> on the{' '}
    ...
    <div className="row">
      <div className="col-sm-4">
        ...
        <ul className="list-unstyled">
          ...
          <li>
            <a className="dropdown-item" href="#1">Mastering Fundamentals</a>
          </li>
          <li>
            <a className="dropdown-item" href="#1">Styling with Themes</a>
          </li>
          <li>
      ...
      <div className="col-sm-4">
        ...
        <ul className="list-unstyled">
          ...
          <li>
            <a className="dropdown-item" href="#1">Security Essentials</a>
          </li>
          <li>
            <a className="dropdown-item" href="#1">Protecting Your Data</a>
          </li>
          <li>
            <a className="dropdown-item" href="#1">Securing Your Browser</a>
          </li>
        </ul>
      </div>
      <div className="col-sm-4">
        <ul className="list-unstyled">
          ...
          <li>
            <a className="dropdown-item" href="#1">For Small Business</a>
          </li>
          <li>
            <a className="dropdown-item" href="#1">For IT Professionals</a>
          </li>
          <li>
    ...
    <div className="row">
      ...
      <div className="col-sm-4">
        <ul className="list-unstyled">
          <li className="dropdown-header">By Audience</li>
          <li>
            <a className="active dropdown-item" href="#1">For Home Users</a>
          </li>
          <li>
            <a className="dropdown-item" href="#1">For Small Business</a>
          </li>
