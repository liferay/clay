...
<div className="sheet-example">
  <div className="sidebar sidebar-light sidebar-sm" style={{maxWidth: '320px'}}>
            ...
            <div className="input-group-inset-item input-group-inset-item-after">
              <button className="btn btn-unstyled d-md-none" type="button">
                <svg
                  ...
                  role="presentation"
                >
                  <use xlinkHref="/icons.svg#times"></use>
                </svg>
              </button>
              <button
      ...
      <nav className="component-navigation-bar navbar navigation-bar navbar-collapse-absolute navbar-expand-md navbar-underline">
        ...
        >
          ...
          <svg
            ...
            role="presentation"
          >
            <use xlinkHref="/icons.svg#caret-bottom" />
          </svg>
        </a>
        <div className="collapse navbar-collapse" id="sidebarLightCollapse00">
          <ul className="nav navbar-nav" role="tablist">
            ...
            <li className="nav-item">
              <a
                ...
                role="tab"
              >
                <span className="navbar-text-truncate">Interface</span>
              </a>
            </li>
            <li className="nav-item">
              <a
                ...
                role="tab"
              >
                <span className="navbar-text-truncate">Fieldsets</span>
              </a>
            </li>
          </ul>
        </div>
                ...
                <div className="sticker">
                  <span className="inline-item">
                    <svg
                      ...
                      role="presentation"
                    >
                      <use xlinkHref="/icons.svg#list" />
                    </svg>
                  </span>
                </div>
              </div>
              <div className="autofit-col autofit-col-expand">
                <div className="list-group-title">Select from List</div>
                <div className="list-group-subtitle">
                ...
                <div className="sticker">
                  <span className="inline-item">
                    <svg
                      ...
                      role="presentation"
                    >
                      <use xlinkHref="/icons.svg#radio-button" />
                    </svg>
                  </span>
                </div>
              </div>
              <div className="autofit-col autofit-col-expand">
                <div className="list-group-title">Single Selection</div>
                <div className="list-group-subtitle">
              ...
              <li className="nav-item">
                ...
                >
                  <svg
                    ...
                    role="presentation"
                  >
                    <use xlinkHref="/icons.svg#info-circle-open" />
                  </svg>
                </a>
              </li>
              <li className="nav-item">
              ...
              >
                ...
                <span className="collapse-icon-closed">
                  <svg
                    ...
                    role="presentation"
                  >
                    <use xlinkHref="/icons.svg#angle-right" />
                  </svg>
                </span>
                <span className="collapse-icon-open">
                  <svg
                    ...
                    role="presentation"
                  >
                    <use xlinkHref="/icons.svg#angle-down" />
                  </svg>
                </span>
              </a>
              <div
                    ...
                    <label>
                      ...
                      <span className="reference-mark">
                        <svg
                          ...
                          role="presentation"
                        >
                          <use xlinkHref="/icons.svg#asterisk" />
                        </svg>
                      </span>
                    </label>
                    <input
                              ...
                              <span className="label-item label-item-after">
                                ...
                                >
                                  <svg
                                    ...
                                    role="presentation"
                                  >
                                    <use xlinkHref="/icons.svg#times-small"></use>
                                  </svg>
                                </button>
                              </span>
                            </span>
            ...
            >
              ...
              <span className="inline-item inline-item-after">
                <svg
                  ...
                  role="presentation"
                >
                  <use xlinkHref="/icons.svg#info-panel-open" />
                </svg>
              </span>
            </button>
          </div>
          <div>
            <button className="btn btn-monospaced btn-primary" type="button">
              A
            </button>
            <button className="btn btn-monospaced btn-secondary" type="button">
              B
            </button>
            <button className="btn btn-monospaced btn-info" type="button">
              C
            </button>
            <button className="btn btn-monospaced btn-success" type="button">
              D
            </button>
            <button className="btn btn-monospaced btn-warning" type="button">
              E
            </button>
            <button className="btn btn-monospaced btn-danger" type="button">
              F
            </button>
            <div className="clay-site-light-container">
              <button className="btn btn-monospaced btn-light" type="button">
                G
              </button>
            </div>
            <button className="btn btn-monospaced btn-dark" type="button">
              H
            </button>
            <button className="btn btn-monospaced btn-link" type="button">
              I
            </button>
          </div>
        </div>
          ...
          <li className="tbar-item">
            <a className="component-action" href="#1" role="button">
              <svg
                ...
                role="presentation"
              >
                <use href="/icons.svg#angle-right"></use>
              </svg>
            </a>
          </li>
          <li className="tbar-item">
      ...
      <nav className="component-navigation-bar navbar navigation-bar navbar-collapse-absolute navbar-expand-md navbar-underline">
        ...
        >
          ...
          <svg
            ...
            role="presentation"
          >
            <use href="/icons.svg#caret-bottom"></use>
          </svg>
        </a>
        <div className="collapse navbar-collapse" id="sidebarLightCollapse00">
          <ul className="nav navbar-nav" role="tablist">
            ...
            <li className="nav-item">
              <a
                ...
                aria-selected="false"
              >
                <span className="navbar-text-truncate">Versions</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <div className="tab-content">
        ...
        >
          ...
          <dl className="sidebar-dl sidebar-section">
            ...
            <dd className="sidebar-dd">
              A picture of a person using a ruler and exacto knife to cut
              construction paper.
            </dd>
            ...
            <dd className="sidebar-dd">
              <span className="label label-lg label-secondary">
                <span className="label-item label-item-expand">Tag One</span>
              </span>
              <span className="label label-lg label-secondary">
                <span className="label-item label-item-expand">Tag Two</span>
              </span>
            </dd>
          ...
          >
            <div className="panel panel-unstyled">
              <a
                ...
                role="tab"
              >
                <span className="panel-title">Collapsible Group Item #1</span>
                <span className="collapse-icon-closed">
                  <svg
                    className="lexicon-icon lexicon-icon-angle-left"
                    focusable="false"
                ...
                <span className="collapse-icon-open">
                  <svg
                    ...
                    role="presentation"
                  >
                    <use href="/icons.svg#angle-down"></use>
                  </svg>
                </span>
              </a>
              <div
          ...
          <ul className="list-group sidebar-list-group">
            <li className="list-group-item list-group-item-flex">
              <div className="autofit-col autofit-col-expand">
                ...
                <div className="list-group-subtext">No Change Log</div>
              </div>
              <div className="autofit-col">
                <div className="dropdown dropdown-action">
                  <a
                  ...
                  <ul
                    ...
                    style={{
                      ...
                      top: '0px',
                      left: '0px',
                      transform: 'translate3d(0px, 811px, 0px)',
                    }}
                    x-out-of-boundaries=""
                  >
                    <li>
  ...
  <div className="sidebar-header">
    <div className="autofit-row sidebar-section">
      <div className="autofit-col autofit-col-expand">
        <div className="component-title">
          <span className="text-truncate-inline">
            <a className="text-truncate" href="#1">Site Configuration</a>
          </span>
        </div>
      </div>
      <div className="autofit-col">
