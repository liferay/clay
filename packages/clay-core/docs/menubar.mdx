    ...
    <div className="collapse menubar-collapse" id="menubarVerticalMdCollapse01">
      <ul className="nav nav-nested-margins">
        <li className="nav-item">
            ...
            <span className="c-inner" tabindex="-1">
              ...
              <span className="collapse-icon-closed">
                <svg
                  ...
                  role="presentation"
                >
                  <use xlink:href="/icons.svg#caret-right" />
                </svg>
              </span>
          ...
          <div className="collapse show" id="menubarVerticalMdNestedCollapse01">
        ...
        <li className="nav-item">
          ...
          <div className="collapse" id="menubarVerticalMdNestedCollapse03">
            <ul className="nav nav-stacked">
              <li className="nav-item">
                <a className="nav-link" href="#1">
                  <span className="c-inner" tabindex="-1">
        ...
        <li className="nav-item">
          ...
          <div className="collapse" id="menubarVerticalMdNestedCollapse04">
            <ul className="nav nav-stacked">
              <li className="nav-item">
                <a className="nav-link" href="#1">
                  <span className="c-inner" tabindex="-1">
      ...
      <li className="nav-item">
        ...
        <div className="collapse show" id="menubarVerticalMdNestedCollapse01">
          <ul className="nav nav-stacked">
            <li className="nav-item">
              <a className="active nav-link" href="#1"
                ><span className="c-inner" tabindex="-1">Details</span></a
              >
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#1"
            ...
            <li className="nav-item">
              ...
              <div className="collapse" id="menubarVerticalMdNestedCollapse02">
                <ul className="nav nav-stacked">
                  <li className="nav-item">
                    <a className="nav-link" href="#1"
                      ><span className="c-inner" tabindex="-1">Details</span></a
            ...
            <li className="nav-item">
              <a className="nav-link" href="#1"
                ><span className="c-inner" tabindex="-1">Site Template</span></a
              >
            </li>
          </ul>
        </div>
      ...
      <li className="nav-item">
        ...
        <div className="collapse" id="menubarVerticalMdNestedCollapse03">
          <ul className="nav nav-stacked">
            <li className="nav-item">
              <a className="nav-link" href="#1"
                ><span className="c-inner" tabindex="-1">Sitemap</span></a
              >
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#1"
                ><span className="c-inner" tabindex="-1">Robots</span></a
              >
            </li>
          </ul>
        </div>
      ...
      <li className="nav-item">
        ...
        <div className="collapse" id="menubarVerticalMdNestedCollapse04">
          <ul className="nav nav-stacked">
            ...
            <li className="nav-item">
              <a className="nav-link" href="#1"
                ><span className="c-inner" tabindex="-1">Staging</span></a
              >
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#1"
                ><span className="c-inner" tabindex="-1">Analytics</span></a
              >
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#1"
                ><span className="c-inner" tabindex="-1">Maps</span></a
              >
            </li>
          </ul>
        </div>
          ...
          >
            ...
            <span className="collapse-icon-closed">
              <svg
                ...
                role="presentation"
              >
                <use xlink:href="{{rootPath}}/icons.svg#caret-right" />
              </svg>
            </span>
            <span className="collapse-icon-open">
              <svg
                ...
                role="presentation"
              >
                <use xlink:href="{{rootPath}}/icons.svg#caret-bottom" />
              </svg>
            </span>
          </button>
          <div
            ...
            <li className="nav-item">
              ...
              >
                <ul className="nav nav-stacked">
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="#1">Documents and Media</a>
                  </li>
                  <li className="nav-item">
      ...
      <li className="nav-item">
        ...
        >
          ...
          <span className="collapse-icon-closed">
            ...
            >
              <use
                xlink:href="{{rootPath}}/icons.svg#caret-right"
              />
            </svg>
          </span>
          <span className="collapse-icon-open">
            ...
            >
              <use
                xlink:href="{{rootPath}}/icons.svg#caret-bottom"
              />
            </svg>
          </span>
        </button>
        <div className="collapse" id="menubarVerticalMdNestedCollapseButton04">
          <ul className="nav nav-stacked">
            <li className="nav-item">
    ...
    <div className="collapse menubar-collapse" id="menubarVerticalLgCollapse01">
      <ul className="nav nav-nested-margins">
        <li className="nav-item">
          ...
          <div className="collapse show" id="menubarVerticalLgNestedCollapse01">
            <ul className="nav nav-stacked">
              <li className="nav-item">
                <a className="active nav-link" href="#1">
                  <span className="c-inner" tabindex="-1">
        ...
        <li className="nav-item">
          ...
          <div className="collapse" id="menubarVerticalLgNestedCollapse03">
            <ul className="nav nav-stacked">
              <li className="nav-item">
                <a className="nav-link" href="#1">
                  <span className="c-inner" tabindex="-1">
        ...
        <li className="nav-item">
          ...
          <div className="collapse" id="menubarVerticalLgNestedCollapse04">
            <ul className="nav nav-stacked">
              <li className="nav-item">
                <a className="nav-link" href="#1">
                  <span className="c-inner" tabindex="-1">
        ...
        <div className="collapse show" id="menubarVerticalLgNestedCollapse01">
          <ul className="nav nav-stacked">
            ...
            <li className="nav-item">
              ...
              <div className="collapse" id="menubarVerticalLgNestedCollapse02">
                <ul className="nav nav-stacked">
                  <li className="nav-item">
                    <a className="nav-link" href="#1"
                      ><span className="c-inner" tabindex="-1">Details</span></a
