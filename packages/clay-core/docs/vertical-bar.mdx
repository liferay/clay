...
packageTypes:
    [
        'clay-core/src/vertical-bar/vertical-bar',
        'clay-core/src/vertical-bar/bar',
        'clay-core/src/vertical-bar/item',
        'clay-core/src/vertical-bar/panel',
        'clay-core/src/vertical-bar/content',
    ]
---
