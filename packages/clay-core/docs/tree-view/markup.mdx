          ...
          <span className="autofit-col">
            <span className="component-icon">
              <svg
                ...
                role="presentation"
              >
                <use xlinkHref="/icons.svg#folder" />
              </svg>
            </span>
          </span>
          <span className="autofit-col autofit-col-expand">
            <span className="component-text">
              <span className="text-truncate-inline" title="Liferay Drive">
                <span className="text-truncate">Liferay Drive</span>
              </span>
            </span>
          </span>
        </span>
                      ...
                      <span className="autofit-col autofit-col-expand">
                        <span className="component-text">
                          <span
                            ...
                            title="Site Template"
                          >
                            <span className="text-truncate">Site Template</span>
                          </span>
                        </span>
                      </span>
                    </span>
    ...
    >
      <span className="c-inner" tabIndex="-2">
        <span className="autofit-row">
          ...
          <span className="autofit-col autofit-col-expand">
            <span className="component-text">
              <span className="text-truncate-inline" title="Repositories">
                <span className="text-truncate">Repositories</span>
              </span>
            </span>
          </span>
        </span>
          ...
          >
            ...
            >
              <span className="autofit-row">
                <span className="autofit-col autofit-col-expand">
                  <span className="component-text">
                    <span className="text-truncate-inline" title="Site Map">
                      <span className="text-truncate">Sitemap</span>
                    </span>
                  </span>
                </span>
              </span>
          ...
          >
            ...
            >
              <span className="autofit-row">
                <span className="autofit-col autofit-col-expand">
                  <span className="component-text">
                    <span className="text-truncate-inline" title="Robots">
                      <span className="text-truncate">Robots</span>
                    </span>
                  </span>
                </span>
              </span>
          ...
          <span className="autofit-col autofit-col-expand">
            <span className="component-text">
              <span
                ...
                title="Documents and Media"
              >
                <span className="text-truncate">Documents and Media</span>
              </span>
            </span>
          </span>
        </span>
          ...
          >
            ...
            >
              <span className="autofit-row">
                <span className="autofit-col autofit-col-expand">
                  <span className="component-text">
                    <span className="text-truncate-inline" title="Staging">
                      <span className="text-truncate">Staging</span>
                    </span>
                  </span>
                </span>
              </span>
          ...
          >
            ...
            >
              <span className="autofit-row">
                <span className="autofit-col autofit-col-expand">
                  <span className="component-text">
                    <span className="text-truncate-inline" title="Analytics">
          ...
          >
            ...
            >
              <span className="autofit-row">
                <span className="autofit-col autofit-col-expand">
                  <span className="component-text">
                    <span className="text-truncate-inline" title="Maps">
                      <span className="text-truncate">Maps</span>
                    </span>
                  </span>
                </span>
              </span>
					...
					<span className="autofit-col">
						...
						>
							<span className="c-inner" tabIndex="-2">
								...
								>
									<use
										xlinkHref="/icons.svg#angle-down"
									/>
								</svg>
								<svg
									className="lexicon-icon lexicon-icon-angle-right component-expanded-d-none"
								...
								>
									<use
										xlinkHref="/icons.svg#angle-right"
									/>
								</svg>
							</span>
						</button>
  ...
  <div className="col-md-4">
    ...
    >
      <li className="treeview-item" role="none">
                ...
                >
                  <span className="c-inner" tabIndex="-2">
                    <svg
                      ...
                      role="presentation"
                    >
                      <use xlinkHref="/icons.svg#times-circle-full" />
                    </svg>
                  </span>
                </button>
              </span>
        ...
        <div className="collapse show" id="treeviewItemDisabledCollapse02">
          <ul className="treeview-group" role="group">
            <li className="treeview-item" role="none">
              <a
              ...
              >
                <span
                  ...
                  style={{marginLeft: '-24px'}}
                >
                  <span className="component-text">Anchor 1</span>
                </span>
              </a>
            </li>
            <li className="treeview-item" role="none">
              ...
              >
                <span
                  ...
                  style={{marginLeft: '-24px'}}
                >
                  <span className="component-text">Anchor 2</span>
                </span>
              </a>
            </li>
            <li className="treeview-item" role="none">
              ...
              >
                <span
                  ...
                  style={{marginLeft: '-24px'}}
                >
                  <span className="component-text">Anchor 3</span>
                </span>
              </a>
            </li>
          </ul>
              ...
              <li className="treeview-item" role="none">
                ...
                >
                  <span
                    ...
                    style={{marginLeft: '-24px'}}
                  >
                    <span className="component-text">Button 1</span>
                  </span>
                </button>
              </li>
              <li className="treeview-item" role="none">
                ...
                >
                  <span
                    ...
                    style={{marginLeft: '-24px'}}
                  >
                    <span className="component-text">Button 2</span>
                  </span>
                </button>
              </li>
              <li className="treeview-item" role="none">
                ...
                >
                  <span
                    ...
                    style={{marginLeft: '-24px'}}
                  >
                    <span className="component-text">Button 3</span>
                  </span>
                </button>
              </li>
            </ul>
					...
					<span className="autofit-col">
						...
						>
							<span className="c-inner" tabIndex="-2">
								...
								>
									<use
										xlinkHref="/icons.svg#times-circle-full"
									/>
								</svg>
							</span>
						</button>
					...
					<span className="autofit-col">
						...
						>
							<span className="c-inner" tabIndex="-2">
								...
								>
									<use
										xlinkHref="/icons.svg#ellipsis-v"
									/>
								</svg>
							</span>
						</button>
    ...
    <div className="collapse show" id="showComponentExpanderCollapse01">
      <ul className="treeview-group" role="group">
        <li className="treeview-item" role="none">
          ...
          <div className="collapse" id="showComponentExpanderCollapse02">
            <ul className="treeview-group" role="group">
              <li className="treeview-item" role="none">
                <div
                  className="treeview-link"
    ...
    <div className="collapse show" id="treeviewCollapseCheckboxHoverBtn01">
      <ul className="treeview-group" role="group">
        <li className="treeview-item" role="none">
          ...
          <div className="collapse" id="treeviewCollapseCheckboxHoverBtn02">
            <ul className="treeview-group" role="group">
              <li className="treeview-item" role="none">
                <div
                  className="treeview-link"
                  ...
                  >
                    <div className="autofit-row">
                      ...
                      <div className="autofit-col autofit-col-expand">
                        <span className="component-text">
                          <span className="text-truncate-inline">
                            <span className="text-truncate" title="Details">
                              Details
                            </span>
                          </span>
                        </span>
    ...
    <div className="collapse show" id="treeviewLightCollapseCheckbox01">
      <ul className="treeview-group" role="group">
        <li className="treeview-item" role="none">
          ...
          <div className="collapse" id="treeviewLightCollapseCheckbox02">
            <ul className="treeview-group" role="group">
              <li className="treeview-item" role="none">
                <div
                  className="treeview-link"
          ...
          >
            ...
            >
              <div className="autofit-row">
                ...
                <div className="autofit-col autofit-col-expand">
                  <span className="component-text">
                    <span className="text-truncate-inline" title="Sitemap">
                      <span className="text-truncate">Sitemap</span>
                    </span>
                  </span>
                </div>
      ...
      <div className="collapse show" id="treeviewDarkCollapseCheckbox01">
        <ul className="treeview-group" role="group">
          <li className="treeview-item" role="none">
            ...
            <div className="collapse" id="treeviewDarkCollapseCheckbox02">
              <ul className="treeview-group" role="group">
                <li className="treeview-item" role="none">
                  <div
                    className="treeview-link"
