  ...
  <div className="sheet sheet-lg">
    ...
    <div className="sheet-section">
      ...
      <div className="form-group">
        ...
        <input className="form-control" id="basicInputTypeEmail" type="email" />
      </div>
      <div className="form-group">
    ...
    <div className="sheet-section">
      ...
      <div className="form-group-autofit">
        <div className="form-group-item">
          ...
          <input className="form-control" id="_iyygmg1c5" type="email" />
        </div>
        <div className="form-group-item">
        ...
        <li className="dropdown nav-item">
          ...
          >
            ...
            <svg
              ...
              role="presentation"
            >
              <use href="/icons.svg#caret-bottom" />
            </svg>
          </a>
          <div className="dropdown-menu dropdown-menu-indicator-end">
            ...
            >
              Setup
              <span aria-hidden="true" className="dropdown-item-indicator">
                <svg
...
<h4 className="sheet-title">
  <span className="autofit-float-sm-down autofit-padded-no-gutters autofit-row">
    ...
    <span className="autofit-col">
      <a className="btn btn-secondary btn-sm" href="#1" role="button">Add</a>
    </span>
    <span className="autofit-col">
      <button className="btn btn-secondary btn-sm" type="button">Remove</button>
    </span>
  </span>
</h4>
          ...
          <div className="dropdown dropdown-action">
            ...
            >
              <svg
                ...
                role="presentation"
              >
                <use xlinkHref="/icons.svg#ellipsis-v" />
              </svg>
            </button>
            <ul aria-labelledby="dropdownSites5" className="dropdown-menu">
              <li>
            ...
            <div className="autofit-col">
              <div className="sticker sticker-success sticker-xl">
                <svg
                  ...
                  role="presentation"
                >
                  <use xlinkHref="/icons.svg#document-pending" />
                </svg>
              </div>
            </div>
        ...
        <div className="sheet sheet-multiple-form">
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="form-group">
                <label htmlFor="commerceFriendlyURL">Friendly URL</label>
                <div className="form-text">https://www.your-domain.com</div>
                    ...
                    <div className="input-group-item">
                      ...
                      <div className="form-feedback-group">
                        <div className="autofit-row">
                          ...
                          <div className="autofit-col">
                            <div className="form-text">56/60</div>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      >
                        <span className="inline-item">
                          <svg
                            ...
                            role="presentation"
                          >
                            <use xlinkHref="/icons.svg#es-es"></use>
                          </svg>
                        </span>
                              ...
                              <span className="autofit-section">
                                <span className="inline-item inline-item-before">
                                  <svg
                                    ...
                                    role="presentation"
                                  >
                                    <use xlinkHref="/icons.svg#en-us"></use>
                                  </svg>
                                </span>
                                en-US
                              </span>
                              ...
                              <span className="autofit-section">
                                <span className="inline-item inline-item-before">
                                  <svg
                                    ...
                                    role="presentation"
                                  >
                                    <use xlinkHref="/icons.svg#en-gb"></use>
                                  </svg>
                                </span>
                                en-GB
                              </span>
                              ...
                              <span className="autofit-section">
                                <span className="inline-item inline-item-before">
                                  <svg
                                    ...
                                    role="presentation"
                                  >
                                    <use xlinkHref="/icons.svg#fr-fr"></use>
                                  </svg>
                                </span>
                                fr-FR
                              </span>
          ...
          <div className="row">
                ...
                <div className="input-group">
                  <div className="input-group-item">
                    <textarea
                      ...
                      placeholder="Some placeholder text..."
                    >
                      El ratón inalámbrico Liferay es el ratón estelar de
                      Liferay, diseñado para ofrecer a los usuarios avanzados
                      comodidad, control y precisión superiores
                    </textarea>
                    <div className="form-feedback-group">
                      <div className="autofit-row">
                        <div className="autofit-col autofit-col-expand">
                        ...
                        <div className="autofit-col">
                          <div className="form-text">114/160</div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="col-md-6">
              <div className="form-group">
                <label htmlFor="commerceKeywords">Keywords</label>
                <div className="input-group">
                  <div className="input-group-item">
                    <textarea
                      aria-label="Amount"
              ...
              <div className="form-group">
                ...
                <div className="card card-type-template">
                  <div className="card-body">
                    <a href="#1">
                      <strong>This is an example of a very long title</strong>
                    </a>
                    <div className="text-success">https://liferay.com</div>
                    <div>
              ...
              <ul className="navbar-nav">
                ...
                <li className="nav-item">
                  <a className="nav-link" href="#1">
                    <span className="navbar-text-truncate">Resources</span>
                  </a>
                </li>
              </ul>
            </div>
            ...
            <li className="dropdown nav-item">
              ...
              >
                <svg
                  ...
                  role="presentation"
                >
                  <use xlinkHref="/icons.svg#filter" />
                </svg>
              </a>
            ...
            <li className="nav-item">
              ...
              >
                <svg
                  ...
                  role="presentation"
                >
                  <use xlinkHref="/icons.svg#order-arrow" />
                </svg>
              </a>
            </li>
          </ul>
                  ...
                  <a className="dropdown-item" href="#1">
                    <span className="dropdown-item-indicator-start">
                      <svg
                        ...
                        role="presentation"
                      >
                        <use xlinkHref="/icons.svg#cards2" />
                      </svg>
                    </span>
                    Card View
                  </a>
          ...
          <div className="c-empty-state c-empty-state-animation">
            ...
            <div className="c-empty-state-title">
              <span className="text-truncate-inline">
                <span className="text-truncate">No page templates yet</span>
              </span>
            </div>
