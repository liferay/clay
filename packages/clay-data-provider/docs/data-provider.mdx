...
<div className="clay-site-alert alert alert-warning">
	<strong className="lead">Warning</strong>
	The use of the <code className="language-text">storage</code> property has been deprecated
	since v3.67.0 in favor of declaring the <code className="language-text">storageMaxSize={100}</code> component in the application root to control cache state and other internal
	details.
</div>
