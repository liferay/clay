...
<div className="sheet-example">
	<span aria-hidden="true" className="loading-animation loading-animation-secondary loading-animation-sm"></span>
</div>
...
<div className="sheet-example">
	<span aria-hidden="true" className="loading-animation-squares loading-animation-lg loading-animation-primary"></span>
</div>
...
<div className="sheet-example">
	<span aria-hidden="true" className="loading-animation loading-animation-secondary loading-animation-xs"></span>
</div>
...
<div className="sheet-example">
	<span aria-hidden="true" className="loading-animation-squares loading-animation-primary loading-animation-md"></span>
</div>
...
<div className="sheet-example">
	<span aria-hidden="true" className="loading-animation-squares loading-animation-primary loading-animation-lg"></span>
</div>
...
<div className="sheet-example">
	<span aria-hidden="true" className="loading-animation-squares loading-animation-md loading-animation-primary"></span>
</div>
...
<div className="sheet-example">
	<span aria-hidden="true" className="loading-animation loading-animation-sm loading-animation-secondary"></span>
</div>
...
<div className="sheet-example">
	<div className="row bg-dark py-3">
		<div className="col-md-3">
			<span aria-hidden="true" className="loading-animation loading-animation-sm loading-animation-light"></span>
		</div>
		<div className="col-md-3">
			<span aria-hidden="true" className="loading-animation-squares loading-animation-md loading-animation-light"></span>
		</div>
	</div>
</div>
