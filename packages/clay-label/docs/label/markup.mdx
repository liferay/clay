...
Use `label-sm` to make the label smaller or `label-lg` to make it larger, or use the mixin `label-size($sassMap)` to create a custom sized label:

<div className="sheet-example">
	<span className="label label-sm label-secondary">
		<span className="label-item label-item-expand">Small Label</span>
	</span>
	<span className="label label-secondary">
...
<span class="label label-sm label-secondary">
	<span class="label-item label-item-expand"> Small Label </span>
</span>
<span class="label label-secondary">
