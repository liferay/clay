...
Using [`inverse`](#api-inverse) property you can use these inverse color variations on Label component:
		...
		<Provider spritemap="/public/icons.svg">
			<div className="p-4">
				<>
					...
					<Label displayType="secondary" inverse>
						Label Secondary
					</Label>
					<Label displayType="warning" inverse>
						Label Warning
					</Label>
					<Label displayType="danger" inverse>
						Label Danger
					</Label>
				</>
			</div>
...
Use the [`size`](#api-size) property to render a smaller (`sm`) or larger (`lg`) label. When omitted, the label uses its default size.
...
export default function App() {
	return (
		<Provider spritemap="/public/icons.svg">
			<div className="p-4">
				<>
					<Label displayType="success" size="sm">
						Small
					</Label>
					<Label displayType="success">Default</Label>
					<Label displayType="success" size="lg">
						Large
					</Label>
				</>
			</div>
