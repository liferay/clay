	...
	<tbody>
		...
		<tr>
			...
			<td class="table-cell-expand">
				...
				<div>
					<a class="table-list-link" href="#1"
						>.table-list-link</a
					>
				</div>
...
<div class="table-responsive">
	<table
		class="show-quick-actions-on-hover table table-list table-nested-rows table-striped"
		role="treegrid"
	>
		<caption>
		...
		<thead>
			<tr>
				...
				<th scope="col">
					<svg
						class="lexicon-icon lexicon-icon-caret-down"
						focusable="false"
						role="presentation"
					>
						<use xlink:href="/images/icons/icons.svg#caret-down" />
				...
				<td role="gridcell">
					<div class="quick-action-menu">
						...
						>
							...
							>
								<use
									xlink:href="/images/icons/icons.svg#trash"
								/>
							</svg>
						</a>
						<a
						...
						>
							...
							>
								<use
									xlink:href="/images/icons/icons.svg#download"
								/>
							</svg>
						</a>
						<a
						...
						>
							<svg
								class="lexicon-icon lexicon-icon-expand"
								focusable="false"
								role="presentation"
							>
								<use
									xlink:href="/images/icons/icons.svg#expand"
								/>
							</svg>
						</a>
					</div>
