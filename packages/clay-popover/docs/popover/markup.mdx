...
<div className="sheet-example">
	<div className="clay-popover-right-top fade popover popover-width-lg show" style={{position: "relative"}}>
		<div className="arrow"></div>
		<div className="inline-scroller">
...
<div className="sheet-example">
	<div className="clay-popover-right-top fade popover popover-secondary popover-width-lg show" style={{position: "relative"}}>
		<div className="arrow"></div>
		<div className="inline-scroller">
			<div className="popover-header">
				<div className="autofit-row autofit-row-center">
...
```html
<div className="clay-popover-right-top popover popover-secondary popover-width-lg">
	<div className="arrow"></div>
	<div className="inline-scroller">
		<div className="popover-header">
			<div className="autofit-row autofit-row-center">
