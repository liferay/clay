    ...
    <div className="clay-popover-top fade popover show">
      ...
      <div className="inline-scroller">
        ...
        <div className="popover-body">
          ...
          White roast seasonal, mocha trifecta, dripper caffeine spoon acerbic
          to go macchiato strong.
        </div>
      </div>
    </div>
...
<div className="sheet-example">
  ...
  >
    ...
    <div className="inline-scroller">
      ...
      <div className="popover-body">
        Viennese flavour cup eu, percolator froth ristretto mazagran caffeine.
        White roast seasonal, mocha trifecta, dripper caffeine spoon acerbic to
        go macchiato strong.
      </div>
    </div>
  </div>
