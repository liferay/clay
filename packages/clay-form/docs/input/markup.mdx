      ...
      <div className="form-feedback-item">
        <span className="form-feedback-indicator">
          <svg
            ...
            role="presentation"
          >
            <use href="/icons.svg#check-circle-full" />
          </svg>
        </span>
      ...
      <div className="form-feedback-item">
        <span className="form-feedback-indicator">
          <svg
            ...
            role="presentation"
          >
            <use href="/icons.svg#warning-full" />
          </svg>
        </span>
        This is a form-feedback-indicator.
      </div>
      ...
      <div className="form-group-item">
        <label for="formValidationLettersOnly">
          ...
          <svg
            ...
            role="presentation"
          >
            <use xlink:href="/icons.svg#asterisk" />
          </svg>
        </label>
        <input
          className="form-control"
        ...
        <div className="invalid-feedback">
          <span className="form-feedback-indicator">
            <svg
              ...
              role="presentation"
            >
              <use xlink:href="/icons.svg#exclamation-full" />
            </svg>
          </span>
        ...
        <div className="valid-feedback">
          <span className="form-feedback-indicator">
            <svg
              ...
              role="presentation"
            >
              <use xlink:href="/icons.svg#check-circle-full" />
            </svg>
          </span>
          This is correct!
        </div>
