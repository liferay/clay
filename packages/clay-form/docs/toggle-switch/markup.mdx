        ...
        >
          ...
          <span className="button-icon button-icon-off toggle-switch-icon">
            <svg
              ...
              role="presentation"
            >
              <use href="/icons.svg#staging"></use>
            </svg>
          </span>
        </span>
      </span>
          ...
          >
            <span className="button-icon button-icon-on toggle-switch-icon">
              <svg
                ...
                role="presentation"
              >
                <use href="/icons.svg#product-menu-open" />
              </svg>
            </span>
            <span className="button-icon button-icon-off toggle-switch-icon">
              <svg
                ...
                role="presentation"
              >
                <use href="/icons.svg#product-menu-closed" />
              </svg>
            </span>
          </span>
        </span>
