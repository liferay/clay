...
Adding an image to the component is easy, just add the property `state` and point the state you want to display.
...
<div class="clay-site-alert alert alert-warning">
	...
	The usage of `imgSrc`, `imgProps`, `imgSrcReducedMotion` and`imgPropsReducedMotion`
	are deprecated. Use the`state` property instead.
</div>
