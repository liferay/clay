        ...
        <div className="autofit-section">
          <span className="alert-indicator">
            <svg
              ...
              role="presentation"
            >
              <use xlinkHref="/icons.svg#info-circle"></use>
            </svg>
          </span>
        </div>
      </div>
        ...
        <div className="autofit-section">
          <span className="alert-indicator">
            <svg
              ...
              role="presentation"
            >
              <use xlinkHref="/icons.svg#check-circle-full"></use>
            </svg>
          </span>
        </div>
      </div>
        ...
        <div className="autofit-section">
          <span className="alert-indicator">
            <svg
              ...
              role="presentation"
            >
              <use xlinkHref="/icons.svg#warning-full"></use>
            </svg>
          </span>
        </div>
      </div>
  ...
  <div className="alert alert-dismissible alert-feedback alert-danger">
    <span className="alert-indicator">
      <svg
        ...
        role="presentation"
      >
        <use xlinkHref="/icons.svg#exclamation-full"></use>
      </svg>
    </span>
    <strong className="lead">Danger Indicator</strong>
    <button
        ...
        <div className="autofit-section">
          <span className="alert-indicator">
            <svg
              ...
              role="presentation"
            >
              <use xlinkHref="/icons.svg#times-circle-full"></use>
            </svg>
          </span>
  ...
  <div className="alert-autofit-row autofit-row">
    <div className="autofit-col autofit-col-expand">
      <div className="autofit-section">
        ...
        <strong className="lead">Success:</strong>
        <span
          >File uploaded. Would you like to add categories automatically?</span
        >
      </div>
    </div>
    <div className="autofit-col">
    ...
    <div className="autofit-col">
      <div className="autofit-section">
        <div className="btn-group">
          ...
          <div className="btn-group-item">
            <button className="btn alert-btn" type="button">Keep Both</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div className="autofit-row alert-autofit-row">
    ...
    <div className="autofit-col">
      <div className="autofit-section">
        <div className="btn-group">
          <div className="btn-group-item">
            <button className="btn btn-info btn-sm" type="button">Add</button>
          </div>
        </div>
      </div>
    </div>
            ...
            <div className="autofit-section">
              <span className="alert-indicator">
                <svg
                  ...
                  role="presentation"
                >
                  <use href="/icons.svg#exclamation-full" />
                </svg>
              </span>
        ...
        <div className="autofit-float autofit-padded autofit-row autofit-row-center">
          ...
          <div className="autofit-col autofit-col-expand">
            <div className="autofit-section">
              ...
              <strong className="lead">Error:</strong> couldn't upload.
            </div>
          </div>
          <div className="autofit-col">
            <button className="btn btn-secondary btn-sm" type="button">
        ...
        <div className="autofit-float autofit-padded autofit-row autofit-row-center">
          ...
          <div className="autofit-col autofit-col-expand">
            <div className="autofit-section">
              ...
              <div className="component-subtitle">Uploaded - 142.1KB</div>
            </div>
          </div>
        </div>
        <button
            ...
            <div className="autofit-section">
              ...
              <div className="progress-group progress-group-stacked">
                ...
                <div className="autofit-row">
                  <div className="autofit-col autofit-col-expand">
                    <div className="component-subtitle">Size: 156.6 MB</div>
                  </div>
                  <div className="autofit-col">
                    <div className="component-subtitle">34%</div>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div className="container-fluid">
      ...
      >
        ...
        <div className="autofit-col autofit-col-expand">
          <div className="autofit-section">
            <button className="btn btn-secondary btn-sm" type="button">
              <span className="inline-item inline-item-before"> ... </span>
              Retry all
            </button>
          </div>
        </div>
