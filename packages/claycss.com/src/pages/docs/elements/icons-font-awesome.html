...
<div class="row">
	<div class="col-md-12">
		...
		<ul class="font-awesome-icons-list list-unstyled">
			<li>
				<span class="icon-caret-bottom-right"></span>
				<span>icon-caret-bottom-right</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-indent-left</span>
			</li>
			<li>
				<span class="icon-indent-right"></span>
				<span>icon-indent-right</span>
			</li>
			<li>
				<span class="icon-facetime-video"></span>
				<span>icon-facetime-video</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-minus-sign</span>
			</li>
			<li>
				<span class="icon-remove-sign"></span>
				<span>icon-remove-sign</span>
			</li>
			<li>
				<span class="icon-ok-sign"></span>
				<span>icon-ok-sign</span>
			</li>
			<li>
				<span class="icon-question-sign"></span>
				<span>icon-question-sign</span>
			</li>
			<li>
				<span class="icon-info-sign"></span>
				<span>icon-info-sign</span>
			</li>
			<li>
				<span class="icon-screenshot"></span>
				<span>icon-screenshot</span>
			</li>
			<li>
				<span class="icon-remove-circle"></span>
				<span>icon-remove-circle</span>
			</li>
			<li>
				<span class="icon-ok-circle"></span>
				<span>icon-ok-circle</span>
			</li>
			<li>
				<span class="icon-ban-circle"></span>
				<span>icon-ban-circle</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-resize-full</span>
			</li>
			<li>
				<span class="icon-resize-small"></span>
				<span>icon-resize-small</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-exclamation-sign</span>
			</li>
			<li>
			...
			<li><span class="icon-chevron-up"></span>
				<span>icon-chevron-up</span>
			</li>
			<li><span class="icon-chevron-down"></span>
				<span>icon-chevron-down</span>
			</li>
			<li><span class="icon-retweet"></span>
				<span>icon-retweet</span>
			</li>
			<li><span class="icon-shopping-cart"></span>
				<span>icon-shopping-cart</span>
			</li>
			<li><span class="icon-folder-close"></span>
				<span>icon-folder-close</span>
			</li>
			<li><span class="icon-folder-open"></span>
				<span>icon-folder-open</span>
			</li>
			<li><span class="icon-resize-vertical"></span>
				<span>icon-resize-vertical</span>
			</li>
			<li><span class="icon-resize-horizontal"></span>
				<span>icon-resize-horizontal</span>
			</li>
			<li><span class="icon-bar-chart"></span>
				<span>icon-bar-chart</span>
			</li>
			<li><span class="icon-twitter-sign"></span>
				<span>icon-twitter-sign</span>
			</li>
			<li>
				<span class="icon-facebook-sign"></span>
				<span>icon-facebook-sign</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-github-sign</span>
			</li>
			<li>
				<span class="icon-upload-alt"></span>
				<span>icon-upload-alt</span>
			</li>
			<li>
				<span class="icon-lemon"></span>
				<span>icon-lemon</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-check-empty</span>
			</li>
			<li>
				<span class="icon-bookmark-empty"></span>
				<span>icon-bookmark-empty</span>
			</li>
			<li>
				<span class="icon-phone-sign"></span>
				<span>icon-phone-sign</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-certificate</span>
			</li>
			<li>
				<span class="icon-hand-right"></span>
				<span>icon-hand-right</span>
			</li>
			<li>
				<span class="icon-hand-left"></span>
				<span>icon-hand-left</span>
			</li>
			<li>
				<span class="icon-hand-up"></span>
				<span>icon-hand-up</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-sign-blank</span>
			</li>
			<li>
				<span class="icon-reorder"></span>
				<span>icon-reorder</span>
			</li>
			<li>
				<span class="icon-list-ul"></span>
				<span>icon-list-ul</span>
			</li>
			<li>
				<span class="icon-list-ol"></span>
				<span>icon-list-ol</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-sort-down</span>
			</li>
			<li>
				<span class="icon-sort-up"></span>
				<span>icon-sort-up</span>
			</li>
			<li>
				<span class="icon-envelope-alt"></span>
				<span>icon-envelope-alt</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-comment-alt</span>
			</li>
			<li>
				<span class="icon-comments-alt"></span>
				<span>icon-comments-alt</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-medkit</span>
			</li>
			<li>
				<span class="icon-fighter-jet"></span>
				<span>icon-fighter-jet</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-h-sign</span>
			</li>
			<li>
				<span class="icon-plus-sign"></span>
				<span>icon-plus-sign</span>
			</li>
			<li>
				<span class="icon-double-angle-left"></span>
				<span>icon-double-angle-left</span>
			</li>
			<li>
				<span class="icon-double-angle-right"></span>
				<span>icon-double-angle-right</span>
			</li>
			<li>
				<span class="icon-double-angle-up"></span>
				<span>icon-double-angle-up</span>
			</li>
			<li>
				<span class="icon-double-angle-down"></span>
				<span>icon-double-angle-down</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-github-alt</span>
			</li>
			<li>
				<span class="icon-folder-close-alt"></span>
				<span>icon-folder-close-alt</span>
			</li>
			<li>
				<span class="icon-folder-open-alt"></span>
				<span>icon-folder-open-alt</span>
			</li>
			<li>
				<span class="icon-expand-alt"></span>
				<span>icon-expand-alt</span>
			</li>
			<li>
				<span class="icon-collapse-alt"></span>
				<span>icon-collapse-alt</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-flag-alt</span>
			</li>
			<li>
				<span class="icon-flag-checkered"></span>
				<span>icon-flag-checkered</span>
			</li>
			<li>
			...
			<li>
				<span class="icon-microphone-off"></span>
				<span>icon-microphone-off</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-calendar-empty</span>
			</li>
			<li>
				<span class="icon-fire-extinguisher"></span>
				<span>icon-fire-extinguisher</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-maxcdn</span>
			</li>
			<li>
				<span class="icon-chevron-sign-left"></span>
				<span>icon-chevron-sign-left</span>
			</li>
			<li>
				<span class="icon-chevron-sign-right"></span>
				<span>icon-chevron-sign-right</span>
			</li>
			<li>
				<span class="icon-chevron-sign-up"></span>
				<span>icon-chevron-sign-up</span>
			</li>
			<li>
				<span class="icon-chevron-sign-down"></span>
				<span>icon-chevron-sign-down</span>
			</li>
			<li>
				<span class="icon-html5"></span>
				<span>icon-html5</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-ellipsis-vertical</span>
			</li>
			<li>
				<span class="icon-rss-sign"></span>
				<span>icon-rss-sign</span>
			</li>
			<li>
				<span class="icon-fb-boolean"></span>
				<span>icon-fb-boolean</span>
			</li>
			<li>
				<span class="icon-text-height"></span>
				<span>icon-text-height</span>
			</li>
			<li>
				<span class="icon-text-width"></span>
				<span>icon-text-width</span>
			</li>
			<li>
			...
			<li>
				<span class="icon-plus-sign-2"></span>
				<span>icon-plus-sign-2</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-hand-down</span>
			</li>
			<li>
				<span class="icon-circle-arrow-left"></span>
				<span>icon-circle-arrow-left</span>
			</li>
			<li>
				<span class="icon-circle-arrow-right"></span>
				<span>icon-circle-arrow-right</span>
			</li>
			<li>
				<span class="icon-circle-arrow-up"></span>
				<span>icon-circle-arrow-up</span>
			</li>
			<li>
				<span class="icon-circle-arrow-down"></span>
				<span>icon-circle-arrow-down</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-pinterest-sign</span>
			</li>
			<li>
				<span class="icon-google-plus-sign"></span>
				<span>icon-google-plus-sign</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-circle-blank</span>
			</li>
			<li>
				<span class="icon-quote-left"></span>
				<span>icon-quote-left</span>
			</li>
			<li>
				<span class="icon-quote-right"></span>
				<span>icon-quote-right</span>
			</li>
			<li>
			...
			<li>
				<span class="icon-play-sign"></span>
				<span>icon-play-sign</span>
			</li>
			<li>
			...
			<li>
				<span class="icon-minus-sign-alt"></span>
				<span>icon-minus-sign-alt</span>
			</li>
			<li>
				<span class="icon-check-minus"></span>
				<span>icon-check-minus</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-sort-by-attributes-alt</span>
			</li>
			<li>
				<span class="icon-sort-by-order"></span>
				<span>icon-sort-by-order</span>
			</li>
			<li>
				<span class="icon-sort-by-order-alt"></span>
				<span>icon-sort-by-order-alt</span>
			</li>
			<li>
				<span class="icon-thumbs-up-2"></span>
				<span>icon-thumbs-up-2</span>
			</li>
			<li>
				<span class="icon-thumbs-down-2"></span>
				<span>icon-thumbs-down-2</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-check-sign</span>
			</li>
			<li>
				<span class="icon-edit-sign"></span>
				<span>icon-edit-sign</span>
			</li>
			<li>
				<span class="icon-external-link-sign"></span>
				<span>icon-external-link-sign</span>
			</li>
			<li>
				<span class="icon-share-sign"></span>
				<span>icon-share-sign</span>
			</li>
			<li>
			...
			<li>
				<span class="icon-renminbi"></span>
				<span>icon-renminbi</span>
			</li>
			<li>
			...
			<li>
				<span class="icon-sort-by-alphabet"></span>
				<span>icon-sort-by-alphabet</span>
			</li>
			<li>
				<span class="icon-sort-by-alphabet-alt"></span>
				<span>icon-sort-by-alphabet-alt</span>
			</li>
			<li>
				<span class="icon-sort-by-attributes"></span>
				<span>icon-sort-by-attributes</span>
			</li>
			<li>
				<span class="icon-youtube-sign"></span>
				<span>icon-youtube-sign</span>
			</li>
			<li>
			...
			<li>
				<span class="icon-xing-sign"></span>
				<span>icon-xing-sign</span>
			</li>
			<li>
			...
			<li>
				...
				<span>icon-bitbucket</span>
			</li>
			<li>
				<span class="icon-bitbucket-sign"></span>
				<span>icon-bitbucket-sign</span>
			</li>
			<li>
			...
			<li>
				<span class="icon-tumblr-sign"></span>
				<span>icon-tumblr-sign</span>
			</li>
			<li>
			...
			<li>
				<span class="icon-db-joinxor"></span>
				<span>icon-db-joinxor</span>
			</li>
			<li>
				<span class="icon-db-state"></span>
				<span>icon-db-state</span>
			</li>
			<li>
				<span class="icon-db-start"></span>
				<span>icon-db-start</span>
			</li>
			<li>
				<span class="icon-db-end"></span>
				<span>icon-db-end</span>
			</li>
			<li>
				<span class="icon-db-fork"></span>
				<span>icon-db-fork</span>
			</li>
			<li>
				<span class="icon-db-condition"></span>
				<span>icon-db-condition</span>
			</li>
			<li>
				<span class="icon-db-task"></span>
				<span>icon-db-task</span>
			</li>
			<li>
				<span class="icon-db-join"></span>
				<span>icon-db-join</span>
			</li>
			<li>
				<span class="icon-fb-button"></span>
				<span>icon-fb-button</span>
			</li>
			<li>
				<span class="icon-fb-fieldset"></span>
				<span>icon-fb-fieldset</span>
			</li>
			<li>
				<span class="icon-fb-custom-field"></span>
				<span>icon-fb-custom-field</span>
			</li>
			<li>
				<span class="icon-fb-separator"></span>
				<span>icon-fb-separator</span>
			</li>
			<li>
				<span class="icon-fb-paragraph"></span>
				<span>icon-fb-paragraph</span>
			</li>
			<li>
				<span class="icon-fb-file-upload"></span>
				<span>icon-fb-file-upload</span>
			</li>
			<li>
				<span class="icon-fb-text"></span>
				<span>icon-fb-text</span>
			</li>
			<li>
				<span class="icon-fb-text-box"></span>
				<span>icon-fb-text-box</span>
			</li>
			<li>
				<span class="icon-fb-select"></span>
				<span>icon-fb-select</span>
			</li>
			<li>
				<span class="icon-fb-radio"></span>
				<span>icon-fb-radio</span>
			</li>
			<li>
				<span class="icon-fb-number"></span>
				<span>icon-fb-number</span>
			</li>
			<li>
				<span class="icon-fb-integer"></span>
				<span>icon-fb-integer</span>
			</li>
			<li>
				<span class="icon-fb-decimal"></span>
				<span>icon-fb-decimal</span>
			</li>
		</ul>
	</div>
</div>