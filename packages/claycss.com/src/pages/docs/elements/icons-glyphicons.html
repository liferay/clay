...
<div class="row">
	<div class="col-md-12">
		...
		<ul class="glyphicons-list list-unstyled">
			<li>
			...
			<li>
				...
				<span>glyphicon glyphicon-download-alt</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-play-circle</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-lock</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-volume-off</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-volume-down"></span>
				<span>glyphicon glyphicon-volume-down</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-volume-up"></span>
				<span>glyphicon glyphicon-volume-up</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-text-height</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-text-width"></span>
				<span>glyphicon glyphicon-text-width</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-align-center</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-align-right"></span>
				<span>glyphicon glyphicon-align-right</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-align-justify"></span>
				<span>glyphicon glyphicon-align-justify</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-indent-left</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-indent-right"></span>
				<span>glyphicon glyphicon-indent-right</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-step-backward</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-fast-backward"></span>
				<span>glyphicon glyphicon-fast-backward</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-backward"></span>
				<span>glyphicon glyphicon-backward</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-fast-forward</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-step-forward"></span>
				<span>glyphicon glyphicon-step-forward</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-chevron-left</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-chevron-right"></span>
				<span>glyphicon glyphicon-chevron-right</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-minus-sign</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-question-sign</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-screenshot</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-remove-circle"></span>
				<span>glyphicon glyphicon-remove-circle</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-arrow-right</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-arrow-down</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-resize-full</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-resize-small"></span>
				<span>glyphicon glyphicon-resize-small</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-exclamation-sign"></span>
				<span>glyphicon glyphicon-exclamation-sign</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-plane</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-calendar"></span>
				<span>glyphicon glyphicon-calendar</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-magnet</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-chevron-up"></span>
				<span>glyphicon glyphicon-chevron-up</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-folder-close</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-resize-horizontal</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-bell</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-thumbs-down</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-hand-right"></span>
				<span>glyphicon glyphicon-hand-right</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-hand-down</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-circle-arrow-right"></span>
				<span>glyphicon glyphicon-circle-arrow-right</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-circle-arrow-left"></span>
				<span>glyphicon glyphicon-circle-arrow-left</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-circle-arrow-up"></span>
				<span>glyphicon glyphicon-circle-arrow-up</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-circle-arrow-down"></span>
				<span>glyphicon glyphicon-circle-arrow-down</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-wrench</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-dashboard</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-heart-empty</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-sort-by-alphabet</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-sort-by-alphabet-alt"></span>
				<span>glyphicon glyphicon-sort-by-alphabet-alt</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-sort-by-order"></span>
				<span>glyphicon glyphicon-sort-by-order</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-sort-by-order-alt"></span>
				<span>glyphicon glyphicon-sort-by-order-alt</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-sort-by-attributes"></span>
				<span>glyphicon glyphicon-sort-by-attributes</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-sort-by-attributes-alt"></span>
				<span>glyphicon glyphicon-sort-by-attributes-alt</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-collapse-down</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-collapse-up"></span>
				<span>glyphicon glyphicon-collapse-up</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-new-window</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-floppy-disk</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-floppy-saved"></span>
				<span>glyphicon glyphicon-floppy-saved</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-floppy-remove"></span>
				<span>glyphicon glyphicon-floppy-remove</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-floppy-save"></span>
				<span>glyphicon glyphicon-floppy-save</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-floppy-open"></span>
				<span>glyphicon glyphicon-floppy-open</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-transfer</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-header</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-compressed"></span>
				<span>glyphicon glyphicon-compressed</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-tower</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-stats"></span>
				<span>glyphicon glyphicon-stats</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-sd-video"></span>
				<span>glyphicon glyphicon-sd-video</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-hd-video"></span>
				<span>glyphicon glyphicon-hd-video</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-subtitles"></span>
				<span>glyphicon glyphicon-subtitles</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-sound-stereo"></span>
				<span>glyphicon glyphicon-sound-stereo</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-sound-dolby"></span>
				<span>glyphicon glyphicon-sound-dolby</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-sound-5-1"></span>
				<span>glyphicon glyphicon-sound-5-1</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-sound-6-1"></span>
				<span>glyphicon glyphicon-sound-6-1</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-sound-7-1"></span>
				<span>glyphicon glyphicon-sound-7-1</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-copyright-mark"></span>
				<span>glyphicon glyphicon-copyright-mark</span>
			</li>

			<li>
				<span class="glyphicon glyphicon-registration-mark"></span>
				<span>glyphicon glyphicon-registration-mark</span>
			</li>
			...
			<li>
				...
				<span>glyphicon glyphicon-cloud-upload</span>
			</li>
