...
<ul class="nav nav-tabs" role="tablist">
	...
	<li class="dropdown nav-item">
		...
		<div class="dropdown-menu">
			<a aria-controls="setup" class="dropdown-item" data-toggle="tab" href="#setup" id="setupTab" role="tab">Setup</a>
			<a aria-controls="supportedClients" class="dropdown-item" data-toggle="tab" href="#supportedClients" id="supportedClientsTab" role="tab">Supported Clients</a>
		</div>
	</li>
</ul>
...
<ul class="nav nav-justified nav-tabs" role="tablist">
	...
	<li class="dropdown nav-item">
		...
		<div class="dropdown-menu">
			<a aria-controls="navJustifiedSetup" class="dropdown-item" data-toggle="tab" href="#navJustifiedSetup" id="navJustifiedSetupTab" role="tab">Setup</a>
			<a aria-controls="navJustifiedSupportedClients" class="dropdown-item" data-toggle="tab" href="#navJustifiedSupportedClients" id="navJustifiedSupportedClientsTab" role="tab">Supported Clients</a>
		</div>
	</li>
</ul>
<div class="tab-content">
...
<ul class="nav nav-tabs" role="tablist">
	...
	<li class="col-6 col-sm-3 dropdown nav-item">
		...
		<div class="dropdown-menu">
			<a aria-controls="navTabsGridSetup" class="dropdown-item" data-toggle="tab" href="#navTabsGridSetup" id="navTabsGridSetupTab" role="tab">Setup</a>
			<a aria-controls="navTabsGridSupportedClients" class="dropdown-item" data-toggle="tab" href="#navTabsGridSupportedClients" id="navTabsGridSupportedClientsTab" role="tab">Supported Clients</a>
		</div>
	</li>
</ul>
<div class="tab-content">
