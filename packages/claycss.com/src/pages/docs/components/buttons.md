...
> `btn-action` is a fixed positioned button that can be positioned on any corner of the page using the classes `btn-action-top-left`, `btn-action-top-right`, `btn-action-bottom-right`, and `btn-action-bottom-left`.

<div class="btn-action">
	<a class="btn btn-primary btn-monospaced btn-lg" href="#1" role="button">
...
<div class="btn-action dropdown">
	<button class="btn btn-primary btn-monospaced btn-lg" data-toggle="dropdown" type="button">
		<svg aria-hidden="true" class="lexicon-icon lexicon-icon-plus">
			<use xlink:href="/vendor/lexicon/icons.svg#plus" />
		</svg>
	</button>
...
<div class="btn-action btn-action-bottom-right dropdown">
	<button class="btn btn-primary btn-monospaced btn-lg" data-toggle="dropdown" type="button">
		<svg aria-hidden="true" class="lexicon-icon lexicon-icon-plus">
			<use xlink:href="/vendor/lexicon/icons.svg#plus" />
		</svg>
