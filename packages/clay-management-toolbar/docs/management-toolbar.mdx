...
packageTypes:
    [
        'clay-management-toolbar/src/management-toolbar',
        'clay-management-toolbar/src/results-bar',
        'clay-management-toolbar/src/item',
        'clay-management-toolbar/src/item-list',
        'clay-management-toolbar/src/results-bar-item',
        'clay-management-toolbar/src/search',
    ]
---
