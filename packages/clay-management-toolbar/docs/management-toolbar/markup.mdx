        ...
        <li className="nav-item">
          ...
          >
            <svg
              ...
              role="presentation"
            >
              <use href="/icons.svg#order-list-up"></use>
            </svg>
          </a>
        </li>
      </ul>
        ...
        <li className="nav-item">
          ...
          >
            <svg
              ...
              role="presentation"
            >
              <use href="/icons.svg#circle-open"></use>
            </svg>
          </a>
        </li>
        <li className="dropdown nav-item">
        ...
        <li className="nav-item nav-divider">
          ...
          >
            <svg
              ...
              role="presentation"
            >
              <use href="/icons.svg#info-circle-open"></use>
            </svg>
          </a>
        </li>
      </ul>
    ...
    <ul className="navbar-nav">
      ...
      <li className="dropdown nav-item">
        ...
        <ul className="dropdown-menu">
          ...
          <li className="dropdown-divider"></li>
          <li>
            <a className="dropdown-item" href="#1">One more separated link</a>
          </li>
        </ul>
      </li>
      <li className="nav-item">
      ...
      <div className="container-fluid container-fluid-max-xl">
        ...
        <ul className="navbar-nav">
          <li className="dropdown nav-item">
            ...
            <ul className="dropdown-menu dropdown-menu-right">
              <li>
                <a className="dropdown-item" href="#1" role="button">Delete</a>
              </li>
              <li>
                <a className="dropdown-item" href="#1" role="button">Copy</a>
              </li>
              <li>
                <a className="dropdown-item" href="#1" role="button">Info</a>
              </li>
            </ul>
          </li>
          <li className="nav-item">
            ...
            <span className="label label-dismissible component-label tbar-label">
              ...
              <span className="label-item label-item-after">
                <button className="btn close" aria-label="close" type="button">
                  ...
                  >
                    <title>times</title>
                    <use href="/icons.svg#times-small"></use>
                  </svg>
                </button>
              </span>
            </span>
