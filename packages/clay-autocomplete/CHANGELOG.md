...
-   **@clayui/autocomplete:** Adds missing `aria-label` attr on Autocomplete stories ([b56a68a](https://github.com/liferay/clay/tree/master/packages/clay-autocomplete/commit/b56a68a))
