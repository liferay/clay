...
export function ClayPaginationWithBasicItems(
	{
		active,
		activePage,
		alignmentPosition,
	...
	return (
		<Pagination {...otherProps} ref={ref}>
			<Pagination.Item
				...
				role={
					previousHref || internalActive === 1 ? undefined : 'button'
				}
			>
...
type ForwardRef = {
	displayName: string;
	(props: IProps & {ref?: React.Ref<HTMLUListElement>}): JSX.Element;
};

export const ForwardPaginationWithBasicItems = React.forwardRef(
	ClayPaginationWithBasicItems
) as ForwardRef;

ForwardPaginationWithBasicItems.displayName = 'ClayPaginationWithBasicItems';
