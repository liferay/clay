...
If you are using the spritemap from `@clayui/css` you can download that svg [here](https://github.com/liferay/clay/blob/master/clayui.com/static/icons.svg).
...
<div className="clay-site-alert alert alert-info">
  For V3, an API was added to utilize context for passing spritemap down instead
  of having to pass the prop everywhere.
</div>
