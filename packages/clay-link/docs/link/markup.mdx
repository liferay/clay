...
<div className="sheet-example">
	<a aria-label="External Link" className="link-primary" href="#link-styles" title="External Link">
		External Link
	</a>
</div>
...
<div className="sheet-example">
	<a aria-label="Title Link" className="component-title link-primary" href="#title-link" title="Title">
		Title Link
	</a>
</div>
