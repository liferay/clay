...
<div className="sheet-example">
	<div className="form-group">
		...
		<div className="blockquote form-text">
...
<div class="form-group">
	...
	<div class="blockquote form-text">http://www.liferay.com/en-us/clay</div>
</div>
```
...
<div className="sheet-example">
	<div className="form-group">
		...
		<div className="blockquote form-text">.form-text</div>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="blockquote form-text">.form-text</div>
</div>
```
