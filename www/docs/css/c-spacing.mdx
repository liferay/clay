...
-   `n1` | **-0.25rem** | _-4px_
-   `n2` | **-0.5rem** | _-8px_
-   `n12px` | \*\*-0.75rem | \_12px\_\_
-   `n3` | **-1rem** | _-16px_
-   `n20px` | \*\*-1.25rem | \_20px\_\_
-   `n4` | **-1.5rem** | _-24px_
-   `n40px` | \*\*-2.5rem | \_40px\_\_
-   `n5` | **-3rem** | _-48px_
-   `n56px` | \*\*-3.5rem | \_56px\_\_
-   `n64px` | \*\*-4rem | \_64px\_\_
-   `n6` | **-4.5rem** | _-72px_
-   `n7` | **-6rem** | _-96px_
-   `n8` | **-7.5rem** | _-120px_
...
<img src="/images/spacing-example.png" className="img-fluid" />
...
<div>
    ...
    <button className="btn-two c-mt-3 c-mt-sm-0 c-ml-sm-3">Publish<button>
</div>
```
...
<div className="sheet-example">
	<div className="h6">c-gap-3</div>
	<div className="d-flex flex-wrap c-gap-3">
		<div className="bg-secondary text-center text-white w-25">1</div>
		<div className="bg-secondary text-center text-white w-25">2</div>
		<div className="bg-secondary text-center text-white w-25">3</div>
		<div className="bg-secondary text-center text-white w-25">4</div>
		<div className="bg-secondary text-center text-white w-25">5</div>
		<div className="bg-secondary text-center text-white w-25">6</div>
	</div>
	<div className="h6 mt-3">c-gapx-3</div>
	<div className="d-flex flex-wrap c-gapx-3">
		<div className="bg-secondary text-center text-white w-25">1</div>
		<div className="bg-secondary text-center text-white w-25">2</div>
		<div className="bg-secondary text-center text-white w-25">3</div>
		<div className="bg-secondary text-center text-white w-25">4</div>
	...
	<div className="h6 mt-3">c-gapy-3</div>
	<div className="d-flex flex-wrap c-gapy-3">
		<div className="bg-secondary text-center text-white w-25">1</div>
		<div className="bg-secondary text-center text-white w-25">2</div>
		<div className="bg-secondary text-center text-white w-25">3</div>
		<div className="bg-secondary text-center text-white w-25">4</div>
