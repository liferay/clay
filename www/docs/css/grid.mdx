...
<div className="clay-site-alert alert alert-warning">
  ...
  <code>.container-form-sm|md|xl</code>, you will need to define them yourself.
</div>
        ...
        <table className="show-quick-actions-on-hover table table-autofit table-heading-nowrap table-list">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <span className="sticker sticker-danger">PNG</span>
              </td>
              ...
              <td>
                <div className="quick-action-menu">
                  <a className="component-action quick-action-item" href="#1">
                    <svg
