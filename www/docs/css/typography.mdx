...
<p>
	capitalized text: <span class="text-capitalize">capitalized text</span>
</p>
```
...
```html
<div>
	Reference Mark<span class="reference-mark" id="referenceMark1"
		>[1]</span
	>
	with text.
</div>
...
<h4>Footnotes</h4>
<div>
	<a class="reference-mark" href="#referenceMark1">[1]</a> A reference to
