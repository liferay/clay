...
```html
<div>
  Reference Mark<span className="reference-mark" id="referenceMark1">[1]</span>
  with text.
</div>
<div>
...
<Sheet>
  <div className="card" style={{maxWidth: '300px'}}>
    <p className="card-body">
      ...
      <a className="text-truncate-inline" href="#1">
        <span className="text-truncate">this is also text-truncate</span>
      </a>
      turkish. Milk filter lungo as galão roast that crema blue mountain shop
      turkish.
    </p>
  </div>
</Sheet>
...
<Sheet>
  ...
  <div>
    <a href="#1" className="text-indigo">
      text-indigo: Milk filter lungo as galão roast that crema blue mountain
      shop turkish.
    </a>
  </div>
  <div>
    <a href="#1" className="text-purple">
      text-purple: Milk filter lungo as galão roast that crema blue mountain
      shop turkish.
    </a>
  </div>
  <div>
  ...
  <div>
    <a href="#1" className="text-orange">
      text-orange: Milk filter lungo as galão roast that crema blue mountain
      shop turkish.
    </a>
  </div>
  <div>
    <a href="#1" className="text-yellow">
      text-yellow: Milk filter lungo as galão roast that crema blue mountain
      shop turkish.
    </a>
  </div>
  <div>
  ...
  <div>
    <a href="#1" className="text-danger">
      text-danger: Milk filter lungo as galão roast that crema blue mountain
      shop turkish.
    </a>
  </div>
</Sheet>
