...
<span className="label label-dismissible label-secondary" tabindex="0">
  <span className="c-inner" tabindex="-1">
    ...
    <span className="label-item label-item-after">
      <button aria-label="Close" className="close" tabindex="-1" type="button">
        <span className="c-inner" tabindex="-1">
          <svg
            className="lexicon-icon lexicon-icon-times"
            focusable="false"
...
<div className="clay-site-alert alert alert-warning">
  Bootstrap's Dropdown Plugin focuses <code>dropdown-toggle</code> on show. You
  will need to manually undo the focus via blur or focus <code>c-inner</code> on
  show.
</div>
