...
<div className="clay-site-alert alert alert-warning">
	Modifying the imports in the `clay.scss` file will require manual
	maintenance of Clay CSS component imports. New components added by Clay CSS
	will not be available in your theme which is probably what you want if you
