...
import {
	...
	DatePickerLocale,
} from '../../../src/components/clay/DatePicker';
...
<div class="clay-site-alert alert alert-warning">
	Take a look at our{' '}
	<a href="https://storybook-clayui.netlify.com/?path=/story/claydatepicker--default">
		Storybook
	</a>{' '}
...
<div class="clay-site-alert alert alert-info">
	...
	<a href="https://liferay.design/lexicon/core-components/forms/picker-date-time/">
		Date & Time Pickers Pattern
	</a>{' '}
