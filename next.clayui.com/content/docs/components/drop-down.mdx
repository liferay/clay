...
import {DropDown, DropDownWithItems} from '../../../src/components/clay/DropDown';
...
<div class="clay-site-alert alert alert-warning">
	...
	Before you get started with this doc, read about <a href="/docs/foundations/composing.html" target="_blank">Clay's fundamentals of composition</a> to move on. The information below is assuming you have read about <a href="/docs/foundations/composing.html" target="_blank">Clay's compositional philosophy</a> and learned about the terms.
</div>
...
const Menu = ({
    ...
    return (
        <div>
            <div>
                <button type="button" onClick={handleExpand}>Home</button>
            </div>
            <div>
                <button type="button" onClick={handleExpand}>Product</button>
            </div>
