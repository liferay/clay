...
sibling: "docs/components/forms/css-text-input.html"
---
...
import {
   ...
   FormInputTextArea,
} from '../../../../src/components/clay/Input';
...
<div class="clay-site-alert alert alert-warning">
   Take a look at our <a href="https://storybook.clayui.com/?path=/story/components-clayinput--separated">Storybook</a> for more information about this component.
</div>

<div class="clay-site-alert alert alert-info">
	Check the <a href="https://liferay.design/lexicon">Lexicon</a> <a href="https://liferay.design/lexicon/core-components/forms/text-input/">Input and Input Groups Pattern</a> for a more in-depth look at the motivations and proper usage of this component.
</div>
