...
packageStatus: "Beta"
sibling: "docs/css/components/tables.html"
---

import {Table} from '../../../src/components/clay/Table';
...
<code class="list-api-item-type">Extends from {`React.TableHTMLAttributes<HTMLTableSectionElement>`}</code>
