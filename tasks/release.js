	...
	gulp.task(
		...
		function(done) {
			...
			cmdPromise.resolve()
				...
				.git('status', '--porcelain', './src/scss/functions/_global-functions.scss').then(checkStatus('It appears that there are new icons. Please commit the modified Sass functions file.'))
				.git('checkout', 'master')
