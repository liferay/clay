...
export default () => (
	<React.Fragment>
		<div className="clay-site-alert alert alert-dark alert-fixed fixed-top alert-fluid">
			<b>Clay V3 is currently in beta</b> for ready-to-use components, use <a href="https://clayui.com" target="_blank">Clay V2</a>.
		</div>
		<nav className="navbar navbar-clay-site navbar-expand-lg navbar-dark fixed-top">
