...
<div class="clay-site-alert alert alert-warning">
	Take a look at our{' '}
	<a href="https://storybook.clayui.com/?path=/story/components-clayinput--separated">
		Storybook
	</a>{' '}
...
<div class="clay-site-alert alert alert-info">
	...
	<a href="https://liferay.design/lexicon/core-components/forms/text-input/">
		Input and Input Groups Pattern
	</a>{' '}
