...
import {
	DropDown,
	DropDownWithItems,
} from '../../../src/components/clay/DropDown';
...
<div class="clay-site-alert alert alert-warning">
	Take a look at our{' '}
	<a href="https://storybook-clayui.netlify.com/?path=/story/claydropdown--default">
		Storybook
	</a>{' '}
...
<div class="clay-site-alert alert alert-info">
	...
	<a href="https://liferay.design/lexicon/core-components/dropdowns/">
		Dropdown Pattern
	</a>{' '}
...
<div>[APITable "clay-drop-down/src/index.tsx"]</div>
