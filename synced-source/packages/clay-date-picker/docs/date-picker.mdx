...
export default function App() {
	...
	return (
		<Provider spritemap="/public/icons.svg">
			<div className="p-4">
				<label htmlFor="datePickerDefault">
					Date Picker
					<Form.HelpText>(Not Localizable)</Form.HelpText>
				</label>
				<DatePicker
...
export default function App() {
	...
	return (
		<Provider spritemap="/public/icons.svg">
			<div className="p-4">
				<label htmlFor="datePickerTime">Time</label>
				<DatePicker
					id="datePickerTime"
					onChange={setValue}
...
export default function App() {
	...
	return (
		<Provider spritemap="/public/icons.svg">
			<div className="p-4">
				<label htmlFor="datePickerRange">Range</label>
				<DatePicker
					id="datePickerRange"
					onChange={setValue}
...
export default function App() {
	...
	return (
		<Provider spritemap="/public/icons.svg">
			<div className="p-4">
				<label htmlFor="datePickerInternationalization">
					Internationalization
				</label>
				<Form.FeedbackGroup>
					<Form.HelpText>Help Text</Form.HelpText>
				</Form.FeedbackGroup>
				<DatePicker
					dateFormat="dd.MM.yyyy"
					firstDayOfWeek={1}
					id="datePickerInternationalization"
					months={[
						'Январь',
						'Февраль',
						'Март',
				...
				/>
				<Form.FeedbackGroup>
					<Form.BlockquoteText>Date to localize</Form.BlockquoteText>
				</Form.FeedbackGroup>
			</div>
		</Provider>
	);
...
export default function App() {
	...
	return (
		<Provider spritemap="/public/icons.svg">
			<div className="p-4">
				<label htmlFor="datePickerCustomFooter">Custom Footer</label>
				<DatePicker
					footerElement={() => <span>Footer Content</span>}
					id="datePickerCustomFooter"
					onChange={setValue}
					placeholder="YYYY-MM-DD"
					value={value}
					years={{
